        ...
        <form action="create.php" method="post">
            <?php global $errors, $review,  $title, $author, $status, $score, $summary; ?>
            <?php $review = [
                'title' => '',
                'author' => '',
                'status' => '',
            ...
            <div class="form-group">
                ...
                <div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="status" id="status1" value="未読" <?php echo ($status === '未読') ? 'checked' : ''; ?>>
                        <label class="form-check-label" for="status1">未読</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="status" id="status2" value="読んでる" <?php echo ($status === '読んでる') ? 'checked' : ''; ?>>
                        <label class="form-check-label" for="status2">読んでる</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="status" id="status3" value="読了" <?php echo ($status === '読了') ? 'checked' : ''; ?>>
